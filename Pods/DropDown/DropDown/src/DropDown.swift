...
extension DropDown {
	...
	public override func layoutSubviews() {
        ...
        //x-xcode-debug-views://7fe72cbfb3d0?DBGViewDebuggerLaunchSessionParameter=7fe72cbfb3d0 The layer is using dynamic shadows which are expensive to render. If possible try setting `shadowPath`, or pre-rendering the shadow into an image and putting it under the layer.
        ...
        tableViewContainer.layer.shouldRasterize = true
        tableViewContainer.layer.rasterizationScale = UIScreen.main.scale
	}
